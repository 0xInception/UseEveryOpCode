...
public class CastclassOpCode : IOpCode
{
    ...
    {
        var method = new MethodDefinition(CilOpCodes.Castclass.ToString(),
            MethodAttributes.Public | MethodAttributes.Static,
            new MethodSignature(CallingConventionAttributes.Default, typeDefinition.Module!.CorLibTypeFactory.Void,
                Enumerable.Empty<TypeSignature>()));
        method.CilMethodBody = new CilMethodBody(method);
        method.CilMethodBody.Instructions.Add(CilOpCodes.Ldc_I4_0);
        method.CilMethodBody.Instructions.Add(CilOpCodes.Castclass, typeDefinition.Module.CorLibTypeFactory.Double.ToTypeDefOrRef());
