...
public class LdlenOpCode : IOpCode
{
    ...
    {
        var method = new MethodDefinition(CilOpCodes.Ldlen.ToString(), MethodAttributes.Public | MethodAttributes.Static,
        ...
        method.CilMethodBody.Instructions.Add(CilOpCodes.Ldlen);
